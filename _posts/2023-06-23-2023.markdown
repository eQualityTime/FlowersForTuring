...
<img src="{{site.baseurl}}/assets/images/{{page.year}}/private.png" alt="4300 pound donation" width=100px />
and 

<img src="{{site.baseurl}}/assets/images/{{page.year}}/corporate.png" alt="4300 pound donation" width=100px />
...
*   The PayPal account was withdrawn to eQuality Time's Unity Bank account and from there will be transferred to Special Effect. 
...
<!-- <img src="{{site.baseurl}}/assets/images/{{page.year}}/final.png" alt="relevant transaction in bank" width=200px /> 
--> 
